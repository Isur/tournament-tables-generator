...
export class init1621461561823 implements MigrationInterface {
    name = 'init1621461561823'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "players" ADD CONSTRAINT "FK_3097b2ebd45555251f68deab349" FOREIGN KEY ("tournamentId") REFERENCES "tournaments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
